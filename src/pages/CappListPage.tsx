...
import { Plus, MagnifyingGlass, Trash, PencilSimple, ArrowsDownUp, WarningCircle, CircleNotch } from '@phosphor-icons/react'
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={isDeleting}
            >
              {isDeleting ? <CircleNotch className="h-4 w-4 animate-spin" /> : null}
              Delete
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
